...
CREATE TABLE `t_data` (
  ...
  `power_factor` varchar(5) DEFAULT NULL COMMENT '电力系数',
  ...
  `voltage_dist_a` float DEFAULT 0 COMMENT 'a相电压畸变率',
  `voltage_dist_b` float DEFAULT 0,
  `voltage_dist_c` float DEFAULT 0,
  `current_dist_a` float DEFAULT 0 COMMENT 'a相电流畸变率',
  `current_dist_b` float DEFAULT 0,
  `current_dist_c` float DEFAULT 0,
  `secondary_absorb_active` float DEFAULT 0 COMMENT '吸收有功二次侧',
  `secondary_release_active` float DEFAULT 0 COMMENT '释放有功二次侧',
  `secondary_inductive_reactive` float DEFAULT 0 COMMENT '感性无功二次侧',
  `secondary_capactive_reactive` float DEFAULT 0 COMMENT '容性无功二次侧',
  `primary_absorb_active` float DEFAULT 0 COMMENT '吸收有功一次侧',
  `primary_release_active` float DEFAULT 0 COMMENT '释放有功一次侧',
  `primary_inductive_reactive` float DEFAULT 0 COMMENT '感性无功一次侧',
  `primary_capactive_reactive` float DEFAULT 0 COMMENT '容性无功二次侧',
